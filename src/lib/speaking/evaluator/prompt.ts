...
Return ONLY valid JSON matching the response schema. bandLow/bandHigh are 0–9 in 0.5 steps; "criteria" has exactly 4 objects in the order listed above; "topFixes" has 1–3 items.`;
