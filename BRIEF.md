...
3. **Контент-процесс W2-3 (BACKLOG)** — теперь главный открытый фронт: без объёма
   ...
   **2026-07-10 — контент-вайп**: по решению владельца прод-каталог R/L и весь прогресс
   ...
   цифрам). Storage-объекты удалённого каталога (mp3, source-html) остались сиротами —
   BACKLOG OPS-1. Последний pg_dump со старым контентом хранится до ~2026-08-09
