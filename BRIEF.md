...
|---|---|---|---|
| Reading/Listening (passage/part и full-тесты) | ✅ 2 practice/день + 2 mock/нед (суммарно R+L, не по секциям; 2026-07-17: контент полностью бесплатен для всех тиров решением владельца — старый full-тест-замок и 25/день mock-кап сняты; trial-механика удалена целиком 2026-08-09, W2-14/миграция 0063) | ✅ безлимит | ✅ безлимит |
...
4. ✅ **Notifications-переработка + upgrade-разруливание** — закрыто 2026-07-08
   ...
   в trial-лейне зачинены до пуша). *(Историческая запись: пивот 2026-07-17 сделал
   trial-лейн недостижимым, механика удалена целиком 2026-08-09 — W2-14, миграция 0063.)*
