...
ОТВЕРГАЕМ остаточный слеш — иначе браузер доклеит вторую ступень после нас. Живой
рендер в Chromium сверен с оригиналом: геометрия ±1px по 10 группам, 0 сетевых
запросов. Тот же день: промпты берутся из `.mcq-stem`/`.summary-line` вопроса, а не
