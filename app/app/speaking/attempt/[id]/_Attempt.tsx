...
const S: Record<string, CSSProperties> = {
  ...
  cuePrompt: { margin: "0 0 16px", fontSize: 18, fontWeight: 700, lineHeight: 1.3, letterSpacing: "-0.01em", color: "var(--text-primary)" },
  ...
  analyH2: { margin: "0 0 6px", fontSize: 21, fontWeight: 800, letterSpacing: "-0.02em", color: "var(--text-primary)" },
