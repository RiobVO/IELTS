        ...
        <div className="wrap">
          ...
          <div className="fgrid">
            <a className="fcard rv" href="/auth">
              ...
              <img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@main/assets/Stopwatch/3D/stopwatch_3d.png" alt="Stopwatch" />
              <div>
            ...
            <a className="fcard rv" href="/auth">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@main/assets/Bar%20chart/3D/bar_chart_3d.png" alt="Bar chart" />
              <div>
            ...
            <a className="fcard rv" href="/auth">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@main/assets/Memo/3D/memo_3d.png" alt="Memo" />
              <div>
            ...
            <a className="fcard rv" href="/auth">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="https://cdn.jsdelivr.net/gh/microsoft/fluentui-emoji@main/assets/Books/3D/books_3d.png" alt="Books" />
              <div>
